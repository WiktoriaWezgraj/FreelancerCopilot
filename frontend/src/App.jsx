...
} from "./utils/analysisHistoryStorage";
...
export default function App() {
  ...
  async function handleAnalyze() {
    if (!briefText.trim()) {
      setErrorMessage("Please paste a client brief first.");
      return;
    }
  ...
  return (
    <main className="app-page">
      <LoadingModal isOpen={loading && !errorMessage} />
        ...
        <section className="app">
          <div className="app-shell">
            ...
            <header className="app-header">
              ...
              <p>
                Paste a client brief, choose your experience level and select
                the estimation currency. The app will help you prepare an early
                project estimate.
              </p>
            </header>
            ...
            <div ref={resultSectionRef}>
              {result ? (
                ...
                <div className="empty-state">
                  ...
                  API key and analyze a real client brief.
                </div>
              )}
            </div>
          </div>
